...
<?php echo $this->Form->create('SubFolder'); ?>
	<fieldset>
		<legend><?php echo __('Edit Sub Folder'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SubFolder.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('SubFolder.id'))); ?></li>
