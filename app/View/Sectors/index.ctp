...
<?php $this->Html->addCrumb(__('Sectors and Jobs List'), '/sectors'); ?>
					<h1>Sectors and Jobs List</h1>
					</div>
				</div>
			</div>
							...
							<div class="table-responsive">
								<table id="table-sector-db" class="table table-bordered table-hover ">
									...
									<tbody>
										...
										<?php
											echo '<tr id="'.$sector['Sector']['id'].'" data-id="'.$sector['Sector']['id'].'">';
											echo '<td class="td_first_block">';
											echo $this->Form->input('sector_jp', array(
												'value' => $sector['Sector']['sector_jp'],
												'class' => "on_change_input form-control",
											...
											echo '</td>';
											echo '<td>';
											echo $this->Form->input('sector_en', array(
							...
							<div class="table-responsive">
								<table id="table-job-db" class="table table-bordered table-hover ">
									...
									<tbody>
										...
										<?php
											echo '<tr id="'.$job['Job']['id'].'" data-id="'.$job['Job']['id'].'">';
											echo '<td class="td_first_block">';
											echo $this->Form->input('job_jp', array(
											...
											echo '</td>';
											echo '<td>';
											echo $this->Form->input('job_en', array(
