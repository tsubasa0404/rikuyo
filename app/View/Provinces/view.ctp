...
<h2><?php echo __('Province'); ?></h2>
	<dl>
		...
		<dt><?php echo __('Province En'); ?></dt>
		<dd>
			<?php echo h($province['Province']['province_en']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Province Jp'); ?></dt>
		<dd>
			<?php echo h($province['Province']['province_jp']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Province Kh'); ?></dt>
		<dd>
			<?php echo h($province['Province']['province_kh']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
...
<div class="related">
	...
	<?php foreach ($province['Agent'] as $agent): ?>
		<tr>
...
<div class="related">
	...
	<tr>
		...
		<th><?php echo __('District Jp'); ?></th>
		<th><?php echo __('District Kh'); ?></th>
		<th class="actions"><?php echo __('Actions'); ?></th>
	</tr>
	<?php foreach ($province['District'] as $district): ?>
		<tr>
			...
			<td><?php echo $district['district_en']; ?></td>
			<td><?php echo $district['district_jp']; ?></td>
			<td><?php echo $district['district_kh']; ?></td>
			<td class="actions">
...
<div class="related">
	...
	<?php foreach ($province['Trainee'] as $trainee): ?>
		<tr>
