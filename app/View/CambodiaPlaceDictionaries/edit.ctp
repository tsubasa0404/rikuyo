...
<?php echo $this->Form->create('CambodiaPlaceDictionary'); ?>
	<fieldset>
		<legend><?php echo __('Edit Cambodia Place Dictionary'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CambodiaPlaceDictionary.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('CambodiaPlaceDictionary.id'))); ?></li>
