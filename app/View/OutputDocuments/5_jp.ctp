						...
						<div class="main-box-body clearfix">
							<div class="print-area">
								...
								<div style="margin-left: 250px;margin-top: 50px">
									...
									<p>
									    <span style="margin-right: 30px">職　　種</span><input type="text" class="job_1" value="<?php echo $this->Foreach->associate_jobs_jp($jobs) ?>" style="width: 300px;">
									</p>
									<p align="left">
								...
								<p align="center" style="margin-bottom: 0px">
								    　上記の者を <input type="text" class="job_2" value="<?php echo $this->Foreach->associate_jobs_jp($jobs) ?>" style="width: 300px;text-align: center">についての技能実習を実施するため、
								</p>
								...
								<div style="padding-left: 50px;">
									...
									<p>
									    帰国後の職種　 ： <input type="text" class="job_2" value="<?php echo $this->Foreach->associate_jobs_jp($jobs) ?>" style="width: 400px;">
									</p>
								</div>
