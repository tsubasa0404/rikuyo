									...
									<table border="1" cellspacing="0" cellpadding="0" width="673" class="table jitco">
										<tbody>
											...
											<tr>
												<td width="213" colspan="2">
													<p align="center">
														<input type="text" value="<?php echo number_format(intval($agent[0]['Agent']['capital_riel'])) ;?> リエル" style="width: 100%;text-align: center"><br>
												...
												<td width="227" colspan="3">
													<p align="center">
														<input type="text" value="<?php echo number_format(intval($agent[0]['Agent']['sales_riel']));?> リエル" style="width: 100%;text-align: center"><br>
											...
											<tr>
												...
												<td width="321" colspan="3">
													<p align="center">
														役職 <input type="text" class="inputW80" value="<?php echo $agent[0]['Agent']['rep_position_en'] ?>" style="text-align: center;width: 180px;">
