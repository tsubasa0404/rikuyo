...
<h2><?php echo __('Commune'); ?></h2>
	<dl>
		...
		<dt><?php echo __('Commune En'); ?></dt>
		<dd>
			<?php echo h($commune['Commune']['commune_en']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Commune Jp'); ?></dt>
		<dd>
			<?php echo h($commune['Commune']['commune_jp']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Commune Kh'); ?></dt>
		<dd>
			<?php echo h($commune['Commune']['commune_kh']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Commune'), array('action' => 'edit', $commune['Commune']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Commune'), array('action' => 'delete', $commune['Commune']['id']), array(), __('Are you sure you want to delete # %s?', $commune['Commune']['id'])); ?> </li>
...
<div class="related">
	...
	<?php foreach ($commune['Agent'] as $agent): ?>
		<tr>
...
<div class="related">
	...
	<?php foreach ($commune['Trainee'] as $trainee): ?>
		<tr>
