...
<?php echo $this->Form->create('TraineeVoice'); ?>
	<fieldset>
		<legend><?php echo __('Edit Trainee Voice'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('TraineeVoice.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('TraineeVoice.id'))); ?></li>
