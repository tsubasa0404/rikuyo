<div class="interviewCandidates index">
	<h2><?php echo __('Interview Candidates'); ?></h2>
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('interview_result_id'); ?></th>
			<th><?php echo $this->Paginator->sort('note'); ?></th>
			<th class="actions"><?php echo __('Actions'); ?></th>
	</tr>
	</thead>
	<tbody>
	<?php foreach ($interviewCandidates as $interviewCandidate): ?>
	<tr>
		<td><?php echo h($interviewCandidate['InterviewCandidate']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($interviewCandidate['InterviewCandidate']['note']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $interviewCandidate['InterviewCandidate']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $interviewCandidate['InterviewCandidate']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $interviewCandidate['InterviewCandidate']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $interviewCandidate['InterviewCandidate']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
