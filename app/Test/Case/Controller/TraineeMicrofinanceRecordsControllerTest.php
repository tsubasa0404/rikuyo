<?php
App::uses('TraineeMicrofinanceRecordsController', 'Controller');

/**
 * TraineeMicrofinanceRecordsController Test Case
 *
 */
class TraineeMicrofinanceRecordsControllerTest extends ControllerTestCase {
