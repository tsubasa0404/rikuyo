<?php
App::uses('AssociationExpensesController', 'Controller');

/**
 * AssociationExpensesController Test Case
 *
 */
class AssociationExpensesControllerTest extends ControllerTestCase {
