<?php
App::uses('TraineeMicrofinanceImagesController', 'Controller');

/**
 * TraineeMicrofinanceImagesController Test Case
 *
 */
class TraineeMicrofinanceImagesControllerTest extends ControllerTestCase {
