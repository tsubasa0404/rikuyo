<?php
App::uses('TraineePhone', 'Model');

/**
 * TraineePhone Test Case
 *
 */
class TraineePhoneTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->TraineePhone = ClassRegistry::init('TraineePhone');
	}
